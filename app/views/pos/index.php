...
<head>
    ...
    <style>
        ...
        /* Asegurar altura mínima para ver los productos en el carrito */
        .pos-cart-items { min-height: 240px; }
...
<body>
    ...
    <div class="pos-wrapper">
        ...
        <div class="pos-cart-panel">
            ...
            <!-- Cart Items -->
            <div class="pos-cart-items d-flex flex-column" id="cartItems">
    ...
    function renderCart() {
        ...
        if(items.length === 0) {
            // limpiar y asegurar que el mensaje "Carrito vacío" exista
            cartDiv.innerHTML = '';
            if (!emptyMsg) {
                emptyMsg = document.createElement('div');
                emptyMsg.id = 'emptyCartMsg';
                emptyMsg.className = 'text-center py-5 d-flex flex-column align-items-center justify-content-center m-auto opacity-50';
                emptyMsg.innerHTML = `
                    <div style="background: rgba(0,0,0,0.04); width: 100px; height: 100px; display: flex; align-items: center; justify-content: center; border-radius: 50%; margin-bottom: 1rem;">
                        <i class="fas fa-shopping-basket fa-3x text-secondary"></i>
                    </div>
